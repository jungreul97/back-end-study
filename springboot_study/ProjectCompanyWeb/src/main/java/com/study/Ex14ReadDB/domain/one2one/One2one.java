package com.study.Ex14ReadDB.domain.one2one;
...
public class One2one {
    ...
    public One2one(String one2oneName, String one2onePhone, String one2oneEmail, String one2oneAddress, String one2oneTitle, String one2oneContent, LocalDate one2oneDate) {
